...
#
setup_keywords['name'] = 'mhw_analysis'
setup_keywords['description'] = 'Marine Heat Wave Analyses'
setup_keywords['author'] = 'Prochaska and Associates'
setup_keywords['author_email'] = 'xavier@ucolick.org'
setup_keywords['license'] = 'BSD'
setup_keywords['url'] = 'https://github.com/profxj/mwh_analysis'
#
...
data_generator = os.walk('mhw_analysis/data')
